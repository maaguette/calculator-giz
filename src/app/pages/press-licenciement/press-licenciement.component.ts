  ...
  process(solde: any, engagementDate: any, licenciementDate: any) {
    ...
    if (this.numberYear < 1) {
      ...
      if (compareDate1 >= compareDate2) {
        ...
        if (this.intervalOlder > 5 && this.intervalOlder <= 10) {
          this.result = Math.round((solde * 5 * 0.35) + (solde * (this.numberYear - 5) * 0.4) + (solde * (1 / 12) * 0.4) + (solde * (this.numberDay / 360) * 0.4));
        }
        if (this.intervalOlder > 10 && this.intervalOlder <= 15) {
          this.result = Math.round((solde * 5 * 0.35) + (solde * 5 * 0.40) + (solde * (this.numberYear - 10) * 0.5) + (solde * (this.numberMonth / 12) * 0.5) + (solde * (this.numberDay / 360) * 0.5));
        }
