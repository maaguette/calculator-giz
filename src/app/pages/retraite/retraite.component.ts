...
export class RetraiteComponent implements OnInit {
  ...
  process() {
    ...
    let compareDate2 = new Date('2019-12-30');
    ...
    if (this.numberYear < 1) {
      ...
      if (compareDate1 < compareDate2) {
        if (this.numberYear <= 5) {
          this.resultIndemnity = Math.trunc((this.numberYear * solde * 0.25) + ((this.numberMonth / 12) * solde * 0.25) + ((this.numberDay / 360) * solde * 0.25));
        }
        if (this.numberYear > 5 && this.numberYear <= 10) {
          this.resultIndemnity = Math.trunc((solde * 5 * 0.25) + (solde * (this.numberYear - 5) * 0.3) + (solde * (this.numberMonth / 12) * 0.3) + (solde * (this.numberDay / 360) * 0.3));
        }
        if (this.numberYear > 10) {
          this.resultIndemnity = Math.trunc((solde * 5 * 0.25) + (solde * 5 * 0.3) + (solde * (this.numberYear - 10) * 0.4) + (solde * (this.numberMonth / 12) * 0.4) + (solde * (this.numberDay / 360) * 0.4));
        }
      }
      if (compareDate1 >= compareDate2) {
        if (this.numberYear <= 5) {
        ...
        if (this.numberYear > 10 && this.numberYear <= 20) {
          this.resultIndemnity = Math.trunc((solde * 5 * 0.25) + (solde * 5 * 0.3) + (solde * (this.numberYear - 10) * 0.45) + (solde * (this.numberMonth / 12) * 0.45) + (solde * (this.numberDay / 360) * 0.45));
        }
        if (this.numberYear > 20) {
          this.resultIndemnity = Math.trunc((solde * 5 * 0.25) + (solde * 5 * 0.3) + (solde * 10 * 0.45) + (solde * (this.numberYear - 20) * 0.5) + (solde * (this.numberMonth / 12) * 0.5) + (solde * (this.numberDay / 360) * 0.5));
        }
      }
  ...
  processMore() {
    ...
    if (this.numberYearMore < 1) {
      ...
      if (compareDate1 >= compareDate2) {
        ...
        if (this.numberYearMore > 10 && this.numberYearMore <= 20) {
          this.resultIndemnityMore = Math.round((totalSolde * 5 * 0.25) + (totalSolde * 5 * 0.3) + (totalSolde * (this.numberYearMore - 10) * 0.45) + (totalSolde * (this.numberMonthMore / 12) * 0.45) + (totalSolde * (this.numberDayMore / 360) * 0.45)
          );
        }
        if (this.numberYearMore > 20) {
          this.resultIndemnityMore = Math.round((totalSolde * 5 * 0.25) + (totalSolde * 5 * 0.3) + (totalSolde * 10 * 0.45) + (totalSolde * (this.numberYearMore - 20) * 0.5) + (totalSolde * (this.numberMonthMore / 12) * 0.5) + (totalSolde * (this.numberDayMore / 360) * 0.5)
          );
        }
      }
